...
export default function FAQPage() {
  ...
  return (
    <div className="w-full bg-white overflow-x-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-12 sm:py-16 md:py-20 lg:py-28">
          ...
          >
            <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
              <HelpCircle className="h-6 sm:h-7 md:h-8 w-6 sm:w-7 md:w-8 flex-shrink-0" />
              <span className="text-xs sm:text-sm font-semibold uppercase tracking-wider bg-white/20 px-2 sm:px-3 py-1 rounded-full">{t('faq.getAnswers')}</span>
            </div>
      ...
      {/* Content */}
      <div className="max-w-4xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-8 sm:py-12 md:py-16 lg:py-20">
        <motion.div
          ...
          {faqs.map((section, sectionIdx) => (
            <motion.div key={sectionIdx} variants={itemVariants}>
              <div className="flex items-start gap-2 sm:gap-3 mb-6 sm:mb-8">
                ...
                <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-gray-900 pb-2 sm:pb-3 border-b-2 border-[#009744]/30 flex-1">
                  ...
                  return (
                    ...
                    >
                      <button
                        ...
                        className="w-full px-3 sm:px-4 md:px-6 py-3 sm:py-4 md:py-5 flex items-start sm:items-center justify-between gap-2 hover:bg-gray-100/50 transition-colors"
                      >
                        <h3 className="text-xs sm:text-sm md:text-base lg:text-lg font-semibold text-gray-900 text-left">{t(faq.qKey)}</h3>
                        <ChevronDown
                          className={`flex-shrink-0 w-4 sm:w-5 h-4 sm:h-5 text-[#009744] transition-transform duration-300 ${
                      ...
                      {openIndex === globalIdx && (
                        <motion.div
                          ...
                          className="px-3 sm:px-4 md:px-6 py-3 sm:py-4 md:py-5 bg-white border-t border-gray-200"
                        >
                          <p className="text-xs sm:text-sm md:text-base text-gray-700 leading-relaxed">{t(faq.aKey)}</p>
                        </motion.div>
                      )}
                    </motion.div>
                  );
        ...
        <motion.div
          ...
          className="mt-12 sm:mt-16 md:mt-20 lg:mt-24 bg-gradient-to-r from-[#009744] via-[#00a852] to-[#006b2f] rounded-xl p-6 sm:p-8 md:p-10 lg:p-12 text-white relative overflow-hidden"
        >
          <div className="absolute inset-0 opacity-10">
            <div className="absolute bottom-0 right-0 w-40 sm:w-48 md:w-64 h-40 sm:h-48 md:h-64 bg-white rounded-full blur-3xl"></div>
          </div>
          <div className="relative text-center">
            <div className="flex justify-center mb-3 sm:mb-4">
              <MessageSquare className="h-8 sm:h-9 md:h-10 w-8 sm:w-9 md:w-10" />
            </div>
            <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold mb-2 sm:mb-3">{t('faq.stillNeed')}</h2>
            <p className="text-sm sm:text-base md:text-lg text-white/90 mb-6 sm:mb-8">{t('faq.stillNeedDesc')}</p>
            <Link
              href="/contact"
              className="inline-block bg-white text-[#009744] hover:bg-gray-100 font-bold py-2 sm:py-3 px-6 sm:px-8 md:px-10 rounded-lg transition-colors text-sm sm:text-base"
            >
              {t('faq.contactUs')}
            </Link>
          </div>
