    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        ...
        >
          ...
          <span className="hidden sm:inline text-xs xs:text-sm">{language.toUpperCase()}</span>
          <span className="sm:hidden text-xs xs:text-sm truncate">{currentLanguageData.nativeName}</span>
        </Button>
      </DropdownMenuTrigger>
